...
export default function PasswordDetail({ entry, onClose, onEdit }: PasswordDetailProps) {
  ...
  return (
    <div className="fixed inset-0 z-40 flex justify-end animate-fade-in">
      ...
      {/* 抽屉 */}
      <div className="relative w-full max-w-md h-full glass border-l border-vault-border animate-slide-in-right overflow-y-auto">
        {/* 头部 */}
        <div className="sticky top-0 glass border-b border-vault-border p-5 flex items-center justify-between z-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-medium text-gray-100">{entry.title}</h2>
        ...
        <div className="p-5 flex flex-col gap-4">
          {fields.map((field, idx) => {
            ...
            return (
              <div key={idx} className="bg-vault-card/40 border border-vault-border rounded-xl p-4">
          ...
          {/* 时间信息 */}
          <div className="text-xs text-vault-muted font-mono flex flex-col gap-1 px-1">
        ...
        {/* 底部操作 */}
        <div className="sticky bottom-0 glass border-t border-vault-border p-4 flex items-center gap-3">
          <button
            onClick={onEdit}
